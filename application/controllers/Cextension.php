...
class Cextension extends CI_Controller {
	...
	public function index(){
		...
		$data['yardDepartments'] = $this->mextensions->yardDepartments();
	...
	public function yard2(){
		...
		$data['securities_yard2_desc'] = $this->mextensions->securities_yard2_desc();		$data['content'] = $this->load->view('contents/v_extension_yard2', $data, TRUE);
		$data['footer'] = $this->load->view('footers/footer', '', TRUE);
		$this->load->view('main', $data);
	}
