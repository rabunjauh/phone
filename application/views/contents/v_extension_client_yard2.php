<div class="container box">
	<div class="row" style="margin-top: 10px">				
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
			<a href="<?= base_url('cextension/pdf_extension_client_y2'); ?>" class="btn btn-primary" target="_blank">Generate PDF</a>
		</div>		
	</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">			
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td class="text-right"><a href="<?= base_url('cextension/pdf_client1_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
					</tr>
					<tr>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">			
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td class="text-right"><a href="<?= base_url('cextension/pdf_client2_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
					</tr>
					<tr>
						<th class="col-md-3">Name</th>
						<th class="col-md-3">Position</th>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">				
					<table class="table table-bordered table-striped">
						<tr>
							...
							<td class="text-right"><a href="<?= base_url('cextension/pdf_client3_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
						</tr>
						<tr>
							<th>Name</th>
							<th>Position</th>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">			
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td class="text-right"><a href="<?= base_url('cextension/pdf_client4_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
					</tr>
					<tr>
						<th>Name</th>
						<th>Position</th>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">			
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td class="text-right"><a href="<?= base_url('cextension/pdf_client5_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
					</tr>
					<tr>
						<th>Name</th>
						<th>Position</th>
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">			
				<table class="table table-bordered table-striped">
					<tr>
						...
						<td class="text-right"><a href="<?= base_url('cextension/pdf_client6_y2'); ?>" class="btn btn-primary" target="_blank">PDF</a></td>
					</tr>
					<tr>
						<th>Name</th>
						<th>Position</th>
