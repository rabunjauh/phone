...
<div class="container box">
	...
	<div class="row">	
		<div class="col-xs-4">
			<table class="table table-bordered table-striped" border="1" width="100%">
					<tr><td colspan="3" class="col-xs-4"><strong><?php echo $topManagements_desc->deptdesc; ?></strong></td></tr>
					<?php
		...
		<div class="col-xs-3">
			<table  class="table table-bordered table-striped">
				<tr>
					<th colspan="2" class="col-xs-3">MEETING ROOM</th>
				</tr>
				<tr>
					<td class="col-xs-2">Employee Name </td>
				...
				<tr>
					...
					<td class="col-xs-1"><?php echo $meetingRoom->extension;?></td></tr>
				<?php endforeach ?>	
			</table>
		</div>
		...
		<div class="col-xs-4">
			...
			<table class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $hrDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
	...
	<div class="row">
		<div class="col-xs-4">
			<table class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $securities_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
		...
		<div class="col-xs-3">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-3"><strong><?php echo $firstAids_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
				...
				<tr>
					...
					<td class="col-xs-1"><?php echo $firstAid->positiondesc; ?></td>
		...
		<div class="col-xs-4">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $teDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
	...
	<div class="row">	
		<div class="col-xs-4">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $hseDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
		...
		<div class="col-xs-3">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-3"><strong><?php echo $financeDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
		...
		<div class="col-xs-4">
			<table class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $misDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
	...
	<div class="row">	
		<div class="col-xs-4">
			<table class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $structuralQaqcDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-1">Position</td>
					<td class="col-xs-1">Ext</td>
		...
		<div class="col-xs-3">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-3"><strong><?php echo $eiQaqcDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-1">Position</td>
					<td class="col-xs-1">Ext</td>
				...
				<?php foreach ($eiQaqcDepartments as $eiQaqcDepartment): ?>
				<tr>
		...
		<div class="col-xs-4">
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $scmDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
	...
	<div class="row">
		<div class="col-xs-4">
			<table class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-4"><strong><?php echo $strEngExtensions_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-2">Position</td>
					<td class="col-xs-1">Ext</td>
		...
		<div class="col-xs-3">
			...
			<table  class="table table-bordered table-striped">
				<tr><td colspan="3" class="col-xs-3"><strong><?php echo $poDepartments_desc->deptdesc; ?></strong></td></tr>
				<tr>
					<td class="col-xs-1">Employee Name</td>
					<td class="col-xs-1">Position</td>
					<td class="col-xs-1">Ext</td>
		...
		<div class="col-xs-4">
			<table  class="table table-bordered table-striped">
				...
				<tr>
					...
					<td class="col-xs-2"><?php echo $eiEng->positiondesc; ?></td>
