...
<div class="container box">
	...
	<div class="row">
		<div class="col-lg-12">
			<h3><?php echo $teDepartments_yard2_desc->deptdesc; ?></h3>
		</div>
	</div>
	...
	<div class="row">	
		<div class="col-lg-12">
			<table class="table table-bordered table-striped" border="1" width="100%">
					...
					<tr>
						<td class="col-lg-5"><?php echo $teDepartment->employeename; ?></td>
						<td class="col-lg-5"><?php echo $teDepartment->positiondesc; ?></td>
						<td class="col-lg-1"><?php echo $teDepartment->extension; ?></td>	
					</tr>
					<?php endforeach; ?>	
				</table>
			</div>
