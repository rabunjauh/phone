		...
		<div class="col-xs-12">
			<?php if (isset($clients3_desc->deptdesc)): ?>
				<table class="table table-bordered table-striped" border="1" width="100%">
					<tr><td colspan="1" class="text-center"><strong>Client 3</strong></td><td colspan="2" class="text-center"><strong><?php echo $clients3_desc->deptdesc; ?></strong></td></tr>
					<tr>
					...
					<tr>
						<td class="col-xs-5"><?php echo $client3->employeename; ?></td>
						<td class="col-xs-5"><?php echo $client3->positiondesc; ?></td>
